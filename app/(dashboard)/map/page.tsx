  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">🗺️ First72 Tamil Nadu Command Center</h1>
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-yellow-700 bg-yellow-100 p-3 rounded border border-yellow-300">
                ...
                <ol className="list-decimal ml-4 space-y-1">
                  ...
                  <li>Run the <code className="bg-yellow-200 px-1 rounded">supabase/schema.sql</code> file from your project</li>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="text-sm border border-gray-300 rounded-lg px-3 py-1.5 bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none"
            >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="bg-white rounded-lg shadow-md border-l-4 border-red-500 p-4 hover:shadow-lg transition-shadow">
          ...
          <div className="text-xs text-gray-500 mt-1">Life-threatening • Immediate response</div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md border-l-4 border-orange-500 p-4 hover:shadow-lg transition-shadow">
          ...
          <div className="text-xs text-gray-500 mt-1">Urgent • Deploy within 30min</div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md border-l-4 border-yellow-500 p-4 hover:shadow-lg transition-shadow">
          ...
          <div className="text-xs text-gray-500 mt-1">Standard priority • 1-2 hours</div>
        </div>

        {/* Safe/Low */}
        <div className="bg-white rounded-lg shadow-md border-l-4 border-green-500 p-4 hover:shadow-lg transition-shadow">
          <div className="text-3xl mb-2">✅</div>
          <div className="text-sm font-medium text-gray-600 mb-1">Safe</div>
          <div className="text-3xl font-bold text-green-600">{stats.low}</div>
          <div className="text-xs text-gray-500 mt-1">Low risk • Routine check</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600">Life-threatening • Immediate dispatch</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600">Urgent • Deploy within 30min</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600">Standard response • 1-2 hours</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="font-semibold text-green-700">Safe (1-3)</div>
                <div className="text-xs text-gray-600">Low risk • Routine check</div>
              </div>
            </div>
            <div className="flex items-center gap-3 pt-2 border-t">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600">First responder locations • 10km radius</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-5 shadow">
